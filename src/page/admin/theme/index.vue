...
<script>
import { getThemeInfoIndex, setThemeInfoIndex } from '../../../utils/authUtils'
...
export default {
  ...
  mounted() {
    this.palettes = themeInfoList
    this.active = getThemeInfoIndex()

    this.list = this.palettes.map((v) => ({
      value: v.value,
      label: v.label,
